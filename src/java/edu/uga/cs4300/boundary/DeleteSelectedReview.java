...
public class DeleteSelectedReview extends HttpServlet {
        ...
        throws ServletException, IOException 
    {
        ...
        // business logic
        rowCount = MovieLogicImpl.deleteReview( id );
        ...
        if( rowCount == 0 ) {
            status = "The review was not successfully deleted!";
        }
        else {
            status = "The review was successfully deleted!";
        }
