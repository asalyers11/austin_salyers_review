...
public class StoreReview extends HttpServlet {
    ...
    static  String          resultTemplateName = "EnterReview-Result.ftl";
        ...
        throws ServletException, IOException 
    {
        ...
        // business logic
        rowCount = MovieLogicImpl.saveReview( title, review );
        movieTitles = MovieLogicImpl.findMovieTitles();
        
        // status of movie-store operation to report to the user 
        if( rowCount == 0 ) {
            status = "The review was not successfully saved!";
        }
        else {
            status = "The review was successfully saved!";
        }
